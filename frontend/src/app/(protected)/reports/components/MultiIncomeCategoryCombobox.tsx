...
/**
 * Multi-select combobox for income categories (responsive)
 ...
 */
export function MultiIncomeCategoryCombobox({
  values,
  onChange,
  ...
  const { open, setOpen, query, setQuery, options, loading } = useRemoteSearch('incomes/categories/list');
