            ...
            {items.map((it, i) => {
              ...
              return (
                <div key={i} className="rounded-lg border p-3 space-y-3">
                  ...
                  {/* Price + Qty — 2-column on all breakpoints */}
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        min={0}
                        placeholder="0.00"
                        value={it.unit_price == null || Number.isNaN(it.unit_price) ? '' : String(it.unit_price)}
                        onChange={(e) => {
...
/**
 * AddOrderDialog — metadata form. Products and lots live in a dedicated sub-dialog.
 */
export function AddOrderDialog({
  ...
  // Preview totals for the summary shown in main dialog
